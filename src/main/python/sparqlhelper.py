                ...
                for  line  in  lines :
                    ...
                    if len(words)>=min_words:
                        try:
                            ...
                            n=n.replace(" (la)","").replace(" (La)","").replace(" (LA)","").replace(" (las)","").replace(" (Las)","").replace(" (LAS)","").replace(" (los)","").replace(" (Los)","").replace(" (LOS)","").replace(" (el)","").replace(" (El)","").replace(" (EL)","").replace("Arag?n","Aragon")
